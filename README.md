...
<div align="center">
  ...
  <img src="logo-osvaldo.jpeg" alt="logo" width="140"  height="auto" />
  <br/>
...
- **[Use Event handlers (No yet)]**
- **[use functional component with hooks (no yet)]**
...
```sh
  cd my-folder
  git@github.com:OsvaldoBC/bookstore-ob.git
```
...
- [ ] **[Create a SPA that include 2 sub-pages]**
...
Feel free to check the [issues page](https://github.com/OsvaldoBC/bookstore-ob/issues).
